            ...
            <div class="container-fluid">
                        ...
                        <div class="col-lg-10">
                            <div class="card card-block z-depth-1 wow zoomIn">
                                ...
                                <div class="md-form">
                                    ...
                                    <input id="c-email" type="text" class="form-control">
                                    <label for="c-email">Email</label>
                                </div>

                                <div class="md-form">
                                    <i class="fa fa-tag prefix"></i>
                                    <input id="c-subject" type="text" class="form-control">
                ...
                <section id="email-sub" class="section">
                    ...
                    <div class="content">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8 z-depth-1 hoverable wow zoomIn">
                                <div class="md-form">
                                    <i class="fa fa-user prefix"></i>
                                    <input id="es-name" type="email" class="form-control">
                                    <label for="es-name">Name</label>
                                </div>
                                <div class="md-form">
                                    <i class="fa fa-envelope prefix"></i>
                                    <input id="es-email" type="email" class="form-control">
                                    <label for="es-email">Email</label>
                                </div>
                                <div class="text-center">
                                    <button class="btn btn-secondary wow tada" data-wow-delay="0.4s">Sign Up&nbsp;<i class="fa fa-pencil-square-o ml-1"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
